...
<section class="v4-news" aria-labelledby="news-heading">
    <div class="v4-section-inner">
        ...
        <?php
        // Self-Heal: News fuer aktuelle/kommende Tagungen seeden, falls
        // die DB noch nichts hat (frischer Deploy). Idempotent.
        bootstrapAutoNewsForCurrentTagungen();
        $newsItems = getActiveNews(3);
        ?>
            ...
            <ol class="v4-news-list">
                ...
                ?>
                    <li class="v4-news-item v4-reveal v4-rd<?= $i + 1 ?>">
                        <?php if ($hasLink): ?>
                        <a class="v4-news-row" href="<?= e($n['link_url']) ?>"<?= $isExt ? ' target="_blank" rel="noopener"' : '' ?>>
                        <?php else: ?>
