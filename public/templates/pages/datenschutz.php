<?php
$pageTitle = 'Datenschutz - ' . SITE_NAME;
?>
...
<div class="bg-white rounded border p-4">
    ...
    <p>
        ...
        Es werden keine Cookies gesetzt und keine Tracking-Dienste eingesetzt.
    </p>

    <h2 class="h5 mt-4">Server-Protokolle</h2>
    <p>
        Zugriffe auf diese Webseite werden in anonymisierter Form protokolliert.
